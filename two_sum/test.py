...
class TestTwoSum(unittest.TestCase):
    ...
    def test_multiple_pairs(self):
        result = set(two_sum([1, 5, 3, 7], 8))
        self.assertIn(result, [{0, 3}, {1, 2}])
    ...
    def test_large_numbers(self):
        self.assertEqual(set(two_sum([10**9, -(10**9), 10**9 - 1, 1], 0)), {0, 1})

    def test_large_positive(self):
        self.assertEqual(set(two_sum([10**9, 10**9 - 1, 1], 10**9 + 1)), {0, 2})

    def test_large_negative(self):
        a, b = -(10**9), -(10**9) + 1  # the two numbers
        self.assertEqual(set(two_sum([a, b, 1], a + b)), {0, 1})

    def test_large_target(self):
        self.assertEqual(set(two_sum([10**9, 10**9], 2 * 10**9)), {0, 1})
